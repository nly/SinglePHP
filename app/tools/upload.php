...
class Upload
{
     ...
     * @param $newName string 新的文件名  不需要类型
    ...
    /**
     * 参数设置
     * @param $params array('maxSize' => 文件上传最大,'allowFileType' => 允许上传的文件类型)
     */
    ...
    /**
     * 文件上传后检测文件内容是否合法
     * @param $uploadInfo string 文件信息
     * @return bool|string 文件源目录
     */
    ...
    /**
     * 获取图片的大小
     * @param $srcFile string 图片地址
     * @param null $srcExt string 图片类型
     * @return array|bool
     */
